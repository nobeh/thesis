...
\end{center}
% \vspace{-20pt}
\caption{Fredhopper's Controller life cycle for data processing requests from customers}
\label{fig:frh-dm}
% \vspace{-5pt}
\end{figure}
% \end{wrapfigure}
...
\caption{Result of experiment measurements without and with using JMSeq on Fredhopper Client API directed with live environment data from customers.}
\label{fig:frh:cs}
\end{center}
\end{figure}
...
\caption{Comparison of different techniques applied to the same program. 
