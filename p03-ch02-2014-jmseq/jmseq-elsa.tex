...
\lstset{language=java}
\begin{lstlisting}[label=ch05:lst:frh:datadispatcher, caption=Controller Data Dispatcher Interface API]
...
% \lstset{language=[AspectJ]Java, morekeywords={suffix, event,ere, CFG, @fail, @match, __RESET}} \begin{lstlisting}[label=ch05:lst:sample_mop, caption=Sample JavaMOP Specification using CFG logic] // Case 1
% SampleCase1(Main m) {
