...
% \CopyrightYear{2011}
% \crdata{978-1-4503-0857-1/12/03}
% --- End of Author Metadata ---

% \title{Programming and Deployment of Active Objects with Application-Level Scheduling%
% \titlenote{This work is partially supported by the EU FP7-231620 project: HATS.}
% }


% \numberofauthors{2}  %set to two to enable longer lines for names and

% \author{
% \alignauthor Behrooz Nobakht\\
% 	\affaddr{Leiden Institute of Advanced Computing}\\
% 	\affaddr{Universiteit Leiden, Leiden, The Netherlands}\\
% 	\email{bnobakht@liacs.nl}
% \alignauthor Frank S. de Boer\\
% 	\affaddr{Centrum Wiskunde and Informatica}\\
% 	\affaddr{Amsterdam, The Netherlands}\\
% 	\email{frb@cwi.nl}
% \and
% \alignauthor Mohammad Mahdi Jaghoori\\
% 	\affaddr{Centrum Wiskunde and Informatica}\\
% 	\affaddr{Amsterdam, The Netherlands}\\
% 	\email{jaghoori@cwi.nl}
% \alignauthor Rudolf Schlatte\\
% 	\affaddr{University of Oslo}\\
% 	\affaddr{Oslo, Norway}\\
% 	\email{rudi@ifi.uio.no}
% }
