...
+\TODO{Why concurrency makes it harder?}
...
+\TODO{Explain the gain of utilization from concurrency perspective.}
...
\TODO{Elaborate the core contributions of this thesis}
...
It is important to note the rapid evolution of programming languages trying to provide an actor-based model of asynchronous message passing.\TODO{Reference}
...
\TODO{Cite polylang as a research recent lang.}
\TODO{Why this category is the best}
...
\TODO{Connect back to the problem statement paraph}

In this thesis, we focus on the concurrency layer of ABS.
We formalize a subset of Java language in regards with ABS\TODO{Check for the way around}.
